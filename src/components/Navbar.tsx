      ...
      <nav className="bg-white shadow-md">
          ...
          <div className="flex justify-between h-16">
            <div className="flex items-center">
              ...
              <div className="hidden sm:ml-6 sm:flex sm:space-x-8">
                ...
                <Link href="/deployments" className={`inline-flex items-center px-1 pt-1 text-gray-700 hover:text-gray-900 ${isActive('/deployments')}`}>
                  Deployments
                </Link>
        ...
        <div className={`${isMobileMenuOpen ? 'block' : 'hidden'} sm:hidden`}>
          <div className="pt-2 pb-3 space-y-1">
            ...
            <Link href="/deployments" className={`block pl-3 pr-4 py-2 text-base font-medium text-gray-700 hover:bg-gray-50 hover:text-gray-900 ${isActive('/deployments')}`}>
              Deployments
            </Link>
